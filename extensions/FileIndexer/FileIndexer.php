 ...
 *        01.10.2010    0.4.5.02    raZe        *    Versionsanhebung fuer Aenderungen in nachgelagerten Dateien
 *        03.10.2010    0.4.5.03    raZe        *    Codemuell entfernt
 *
 * BESCHREIBUNG:
    ...
    if ($sExecutionCommand != ""){
        ...
        foreach ($sDocText as $sDocLine){
            ...
            if($wgFiLowercaseIndex){
                ...
                $sDocLine = ereg_replace("[[:punct:]][[:space:]]|[[:space:]][[:punct:]]|[[:punct:]][[:punct:]]", " ", $sDocLine);
            }
